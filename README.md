[![Build](https://github.com/jidicula/random-standup/actions/workflows/build.yml/badge.svg)](https://github.com/jidicula/random-standup/actions/workflows/build.yml) [![Latest Release](https://github.com/jidicula/random-standup/actions/workflows/release-draft.yml/badge.svg)](https://github.com/jidicula/random-standup/actions/workflows/release-draft.yml) [![Go Report Card](https://goreportcard.com/badge/github.com/jidicula/random-standup)](https://goreportcard.com/report/github.com/jidicula/random-standup) [![Go Reference](https://pkg.go.dev/badge/github.com/jidicula/random-standup.svg)](https://pkg.go.dev/github.com/jidicula/random-standup)
